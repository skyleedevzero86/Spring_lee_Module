...
@Component
public class StubEnrichmentEngine {

	private final AiProperties aiProperties;
	private final EnrichmentPromptTemplate enrichmentPromptTemplate;

	public StubEnrichmentEngine(AiProperties aiProperties, EnrichmentPromptTemplate enrichmentPromptTemplate) {
		this.aiProperties = aiProperties;
		this.enrichmentPromptTemplate = enrichmentPromptTemplate;
	}

	public AiEnrichmentPort.EnrichmentResult enrich(AiEnrichmentPort.EnrichmentRequest request) {
		enrichmentPromptTemplate.renderUserPrompt(request);
